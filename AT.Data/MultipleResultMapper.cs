...
namespace AT.Data
{
    ...
    {
        Dictionary<String, Int32> _mapColumnNameToColumnPosition = new Dictionary<string, int>();
        ...
        static object GetField(object obj, string fieldName, bool bThrowException = true)
        {
